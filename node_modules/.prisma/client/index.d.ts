  ...
  */
  ...
  export type WorkGetPayload<S extends boolean | null | undefined | WorkArgs> =
    ...
    : S extends { select: any } & (WorkArgs | WorkFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :  P extends keyof Work ? Work[P] : never
  } 
      : Work
  ...
  export interface WorkDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<WorkGetPayload<T>>>
   ...
   */
  export class Prisma__WorkClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    ...
    ? User  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'work' ? Array < WorkGetPayload<S['include'][P]>>  :
        P extends '_count' ? UserCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (UserArgs | UserFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'work' ? Array < WorkGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    work<T extends UserWorkArgs= {}>(args?: Subset<T, UserWorkArgs>): PrismaPromise<Array<WorkGetPayload<T>>| Null>;
  ...
  export type WorkWhereInput = {
    ...
    timeStarted?: DateTimeFilter | Date | string
    minutes?: StringFilter | string
  ...
  export type WorkScalarWhereWithAggregatesInput = {
    ...
    timeStarted?: DateTimeWithAggregatesFilter | Date | string
    minutes?: StringWithAggregatesFilter | string
  ...
  export type WorkCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<WorkCreateWithoutUserInput>, Enumerable<WorkUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<WorkCreateOrConnectWithoutUserInput>
  ...
  export type WorkUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<WorkCreateWithoutUserInput>, Enumerable<WorkUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<WorkCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<WorkUpsertWithWhereUniqueWithoutUserInput>
    createMany?: WorkCreateManyUserInputEnvelope
    set?: Enumerable<WorkWhereUniqueInput>
    disconnect?: Enumerable<WorkWhereUniqueInput>
    delete?: Enumerable<WorkWhereUniqueInput>
    connect?: Enumerable<WorkWhereUniqueInput>
    update?: Enumerable<WorkUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<WorkUpdateManyWithWhereWithoutUserInput>
  ...
  export type WorkCreateManyUserInputEnvelope = {
    data: Enumerable<WorkCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type WorkUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<WorkUpdateManyMutationInput, WorkUncheckedUpdateManyWithoutWorkInput>
  }
  ...
  export type WorkUncheckedUpdateManyWithoutWorkInput = {
    id?: IntFieldUpdateOperationsInput | number
    username?: StringFieldUpdateOperationsInput | string
    timeStarted?: DateTimeFieldUpdateOperationsInput | Date | string
    minutes?: StringFieldUpdateOperationsInput | string
